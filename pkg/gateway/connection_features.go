...
func (s *gateway) connectionFeatures() []connectionFeature {
...
func (s *gateway) auditConnectionFeature(ctx gossh.Context, conn net.Conn) net.Conn {
	return newCloseNotifyConn(conn, s.startConnectionAudit(ctx, conn))
}

func (s *gateway) sessionPolicyConnectionFeature(ctx gossh.Context, conn net.Conn) net.Conn {
