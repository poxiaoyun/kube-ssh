...
func newRootCmd() *cobra.Command {
	...
	f.StringArrayVar(&opts.Authentication.Methods, "authentication-method", opts.Authentication.Methods, "enabled SSH authentication method: publickey or password; repeatable, defaults to both")
	f.BoolVar(&opts.Authentication.Anonymous, "authentication-anonymous", opts.Authentication.Anonymous, "accept credentials for enabled SSH authentication methods as anonymous")
